...
//     final result = await signOut.call(const NoParams());
//     result.fold(
//           (failure) => emit(AuthError(message: failure.message, code: '')),
...
//     result.fold(
//           (failure) => emit(PasswordResetError(message: failure.message, code: '')), // ADDED code parameter
...
//     result.fold(
//           (failure) => emit(EmailVerificationError(message: failure.message, code: '')), // ADDED code parameter
